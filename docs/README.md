...
La url en la que se despliega es: [https://arquisoft.github.io/dede_es3a_bis2/](https://arquisoft.github.io/dede_es3a_bis2/).

### Build Documentación

Para la documentación vamos a utilizar [AsciiDoc](https://asciidoc.org/) y [PlantUML](https://plantuml.com). Seguiremos la plantilla [Arc42](https://github.com/arc42/arc42-template). Si quieres generar la documentación en tu ordenador, necesitas instalar Ruby, Java y algunas dependencias para traducir el asciidoc en código html. Si estás en una máquina Linux puedes instalar Java y Ruby simplemente ejecutando:
...
Si queremos desplegar la documentación en GitHub pages, estará accesible en [https://arquisoft.github.io/dede_es3a_bis2/](https://arquisoft.github.io/dede_es3a_bis2/) necesitamos ejecutar `npm run deploy`.
