...
The deployment url is: [https://arquisoft.github.io/dede_es3a_bis2/](https://arquisoft.github.io/dede_es3a_bis2/)
...
If we want to deploy it to GitHub pages, so it is accesible via [https://arquisoft.github.io/dede_es3a_bis2/](https://arquisoft.github.io/dede_es3a_bis2/) we need to execute `npm run deploy`.
